...
echo "$($PSQL "SELECT major_id, Count(first_name) AS number_of_students, ROUND(AVG(gpa), 2)AS average_gpa FROM students GROUP BY major_id HAVING Count(first_name) > 1;")"
